...
world.add(pi_img,'membrane_image',colormap='invert_grey')
...
smooth_img = linear_filtering(membrane_img, std_dev=5.0, method='gaussian_smoothing')
background_img = (smooth_img<background_threshold).astype(np.uint16)
eroded_background_img = morphology(background_img,method="erosion")

seed_img += eroded_background_img

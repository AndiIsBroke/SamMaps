...
ref_ldmk=$path/'landmarks-no_outliers-t'$t_ref'_relab_t'$t_float'.txt'
float_ldmk=$path/'landmarks-no_outliers-t'$t_float'.txt'
...
float_rig_ldmk=$path/'landmarks-no_outliers-rigid-t'$t_float'.txt'
# - Affine registration:
...
echo "INPUT FILES:"
echo " - floating image:" $float_im
echo " - reference image:" $ref_im
echo " - floating landmarks file:" $float_ldmk
echo " - reference landmarks file:" $ref_ldmk
echo ""
echo "INPUT PARAMETERS:"
echo " - vector-propagation-distance:" $vpd
echo " - fading-distance:" $fd
echo " - fluid-sigma:" $fs
echo ""
...
echo "ipython /data/Meristems/Carlos/SamMaps/scripts/YR/quiver3d_visu.py $ref_ldmk $float_rig_ldmk"
...
echo "ipython /data/Meristems/Carlos/SamMaps/scripts/YR/quiver3d_visu.py $ref_ldmk $float_aff_ldmk"
...
./blockmatching -floating $float_im -reference $ref_im \
  ...
  -res-trsf $res_trsf -trsf-type 'vectorfield' -time -py-hl 5 -py-ll 1
